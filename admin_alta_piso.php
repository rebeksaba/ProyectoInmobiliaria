...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO pisos (Codigo_piso, calle, numero, piso, puerta, cp, metros, zona, precio, imagen)
            VALUES ($codigo, '$calle', $numero, $piso, '$puerta', $cp, $metros, '$zona', $precio, '$imagen')";
...
<form method="POST" class="formulario">
    ...
    <label>Imagen (URL o nombre):</label><br>
